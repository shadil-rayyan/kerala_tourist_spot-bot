...
#it better
@bot.message_handler(func=lambda message: message.text =="kannur_button")
def  kannur_button_selected(message):
 ...
 #Respond with a message when the user selects "" and include the nested keyboard
  bot.send_message(message.chat.id, 'Welcome to kannur! What would you like to explore?', reply_markup=nest_nested_keyboard)